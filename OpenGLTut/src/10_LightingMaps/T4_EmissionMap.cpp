...
//    std::string vsFile1 = "/src/10_LightingMaps/ShaderFiles/t4_lighting_maps.vs";
//    std::string frsFile1 = "/src/10_LightingMaps/ShaderFiles/t4_lighting_maps.frs";
...
//    std::strncpy(imageFile, currentDir, maxDir - 1);
//    std::strncat(imageFile, "/Resources/imgs/matrix.jpg", maxDir - strlen(imageFile) - 1);
//    unsigned int emissionMap = loadTexture(imageFile);
//
...
//        lightingShader.use();
//        lightingShader.setFloat("Time", currentFrame / 4.0f);
