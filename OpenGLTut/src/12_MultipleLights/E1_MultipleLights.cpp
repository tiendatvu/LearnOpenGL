...
int main()
{
    ...
    std::string vsFile1 = "/src/12_MultipleLights/ShaderFiles/e1_multiple_lights.vs";
    std::string frsFile1 = "/src/12_MultipleLights/ShaderFiles/e1_multiple_lights.frs";
    Shader lightingShader(currentDir + vsFile1, currentDir + frsFile1);
    std::string vsFile2 = "/src/12_MultipleLights/ShaderFiles/e1_light_cube.vs";
    std::string frsFile2 = "/src/12_MultipleLights/ShaderFiles/e1_light_cube.frs";
