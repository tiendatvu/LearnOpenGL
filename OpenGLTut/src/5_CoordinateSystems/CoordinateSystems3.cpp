...
//        // create view matrix
//        view = glm::translate(view, glm::vec3(1.0f * glm::sin((float)glfwGetTime()), 1.0f * glm::sin((float)glfwGetTime()), -3.0f * glm::sin((float)glfwGetTime()))); // move the texture a bit further from the camera position 
