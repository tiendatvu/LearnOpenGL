// Task 4: Use a uniform variable as the mix function's third parameter to vary the amount the two textures are visible. 
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "LearnOpenGL_TextureTask4", NULL, NULL);
    if (window == NULL)
    {
