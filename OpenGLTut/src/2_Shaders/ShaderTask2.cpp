//// Task2: Specify a horizontal offset via a uniform and move the triangle to the right side of the screen in the vertex shader using this offset value
//
//#include <glad/glad.h>
...
//
//    std::string vsFile1 = "/src/2.Shaders/ShaderFiles/shader3.vs";
