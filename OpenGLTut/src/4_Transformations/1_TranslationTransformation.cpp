...
//    //ourShader.use(); // ourShader.use() here also works
//
//    // set up vertex data and buffer, then configure vertex attributes
//    unsigned int VBO, VAO, EBO;
//    ConfigureVertexAttributes(VBO, VAO, EBO);
//    glBindVertexArray(0); // because we bind VAO for each while loop -> we could unbind the VAO every where, after the render taking place
//
...
//    ourShader.use(); // use() shader here to bind the textures
...
//        ourShader.use(); // use() shader here to assign the uniform variable
