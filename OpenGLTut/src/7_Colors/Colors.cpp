...
//    std::string vsFile1 = "/src/7_Colors/ShaderFiles/colors.vs";
//    std::string frsFile1 = "/src/7_Colors/ShaderFiles/colors.frs";
//    Shader lightingShader(currentDir + vsFile1, currentDir + frsFile1);
//    std::string vsFile2 = "/src/7_Colors/ShaderFiles/light_cube.vs";
//    std::string frsFile2 = "/src/7_Colors/ShaderFiles/light_cube.frs";
...
//    // (it's already bound, but we do it again for educational purpose)
//    glBindBuffer(GL_ARRAY_BUFFER, VBO);
//
//    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);
//    glEnableVertexAttribArray(0);
