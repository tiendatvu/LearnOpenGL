...
//float yaw = -90.0f; // yaw is initialized to -90.0 degrees since a yaw 0.0 results in a direction vector pointing to the right so we initially rotate a bit to the left.
//float pitch = 0.0f;
...
//    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "LearnOpenGL_CameraMouseZoom", NULL, NULL);
//    if (window == NULL)
//    {
...
//    std::string vsFile1 = "/src/6_Camera/ShaderFiles/Shader1.vs";
//    std::string frsFile1 = "/src/6_Camera/ShaderFiles/shader1.frs";
//    Shader ourShader(currentDir + vsFile1, currentDir + frsFile1);
//
//    // set up vertex data and buffers and configure vertex atrributes
//    float vertices[] = {
