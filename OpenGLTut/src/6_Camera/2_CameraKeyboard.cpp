...
//    stbi_image_free(data);
//
//    // tell opengl for each sampler to whichs texture unit it belongs to (only has to be done once)
//    ourShader.use();
...
//            glm::mat4 model = glm::mat4(1.0f); // make sure to init matrix to identity matrix first
...
//    glm::vec3 a1 = glm::normalize(glm::cross(cameraFront, cameraUp));
//
