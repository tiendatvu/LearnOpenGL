...
//
//    // window creation
//    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "LearnOpenGL_CameraCircle", NULL, NULL);
//    if (window == NULL)
//    {
...
//    }
//
//    // configure global opengl status
...
//        glm::mat4 view = glm::mat4(1.0f); // make sure to init matrix to identity matrix first
//        float radius = 10.0f;
