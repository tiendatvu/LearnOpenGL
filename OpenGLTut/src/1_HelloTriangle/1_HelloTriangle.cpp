...
//    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "LearnOpenGL_HelloTriangle", NULL, NULL);
//    if (window == NULL)
//    {
...
//
//    glBindBuffer(GL_ARRAY_BUFFER, VBO); // bind the data to the address VBO
...
//    glBindBuffer(GL_ARRAY_BUFFER, 0); // -> unbind data, because data is store inside of VBO
//
//    // You can unbind the VAO afterwards so other VAO call won't accidently modify this VAO,
//    // but this rarely happens.
//    // Modifying other VAOs requires a call to glBindVertexArray anyways so we generally don't unbind VAOs
//    // (nor VBOs) when it's not directly necessary.
//    glBindVertexArray(0); // unbind data, because VAO is already bound with the VBO
//
//    // wrireframe polygons
...
//
//    // glfw: terminate, cleaning all previously allocated GLFW resources
//    glfwTerminate();
//    return 0;
//}
//
