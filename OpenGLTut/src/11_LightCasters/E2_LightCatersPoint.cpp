...
//    // --------------------
//    lightingShader.use();
//    lightingShader.setInt("material.diffuse", 0); // set to texture at the location: GL_TEXTURE0
//    lightingShader.setInt("material.specular", 1); // set to texture at the location: GL_TEXTURE1
//
...
//        lightPos = glm::vec3(3 * glm::sin(currentFrame), 3, 3 * glm::cos(currentFrame));
//
//        // input
//        // -----
//        processInput(window);
...
//        // added properties of light source -> create faded effect of its
