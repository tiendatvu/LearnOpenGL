// Example 1: Define the light caster (light source) as a Directional Light: 
// - consider the light as far away from all the objects (like the sun to the people on the Earth)
// - the direction from the light source to all the objects is the same
...
int main()
{
    ...
    std::string vsFile1 = "/src/11_LightCasters/ShaderFiles/e1_light_casters.vs";
    std::string frsFile1 = "/src/11_LightCasters/ShaderFiles/e1_light_casters.frs";
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.use();
        lightingShader.setVec3("light.direction", glm::vec3(-1.0) * lightPos);
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            float angle = 20.0f * (i + 5) * currentFrame;
