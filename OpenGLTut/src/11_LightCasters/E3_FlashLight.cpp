// Example 3: A flashlight is a spotlight located at the viewer's position and usually aimed straight ahead from the player's perspective
//            - Assume the the light source is a FlashLight, and that FlashLight is always at the camera position
//              -> light's position = camera's position
//                 light's direction = camera's front vector (the direction toward which the camera points)
//            - There is a cut-off angle of the flash light: inside -> lit, outside -> not lit
...
int main()
{
    ...
    std::string vsFile1 = "/src/11_LightCasters/ShaderFiles/e3_light_casters.vs";
    std::string frsFile1 = "/src/11_LightCasters/ShaderFiles/e3_light_casters.frs";
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setFloat("light.cutOff", glm::cos(glm::radians(121.5f)));
