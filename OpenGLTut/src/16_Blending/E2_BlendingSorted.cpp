...
//    std::string vsFile1 = "/src/16_Blending/ShaderFiles/e2_blending.vs";
//    std::string frsFile1 = "/src/16_Blending/ShaderFiles/e2_blending.frs";
...
//    unsigned int cubeTexture = loadTexture(imageFile);
//    std::strncpy(imageFile, currentDir, maxDir - 1);
//    std::strncat(imageFile, "/Resources/imgs/wall.jpg", maxDir - strlen(imageFile) - 1);
//    unsigned int floorTexture = loadTexture(imageFile);
//    std::strncpy(imageFile, currentDir, maxDir - 1);
//    std::strncat(imageFile, "/Resources/imgs/blending_transparent_window.png", maxDir - strlen(imageFile) - 1);
